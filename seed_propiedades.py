...
# Coincide con el DJANGO_SETTINGS_MODULE real de Proyecto CHAPALA
# (ver mychapala/seed_data.py, que usa el mismo valor).
# Debe configurarse ANTES de importar cualquier modelo de Django.
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "chapala.settings")
django.setup()

from reportes.models import PropiedadCatalogo, PropiedadSistema, SistemaFluido  # noqa: E402
